  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1, fontSize: '0.9375rem', color: 'var(--text-primary)', lineHeight: 1.4 }}>
          <span style={{ fontWeight: 600 }}>Action Required:</span> Your profile is incomplete. Add a social link (LinkedIn or Instagram), your location, and bio so others can connect with you!
        </div>
        <button 
